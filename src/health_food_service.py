...
"""
        ...
        if self.offline:
            log_info("MCP_OFFLINE enabled: skip HealthFoodService scheduler and updates.")
            if not os.path.exists(self.db_path):
                log_error(
                    "Health Food DB not found in offline mode. Provide data/health_foods.db."
                )
        else:
    ...
    def _update_data(self):
        ...
        if self.offline:
            log_info("MCP_OFFLINE enabled: skip HealthFoodService update.")
            return
